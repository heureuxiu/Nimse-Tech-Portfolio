  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-6">
        ...
        <p className="text-primary text-sm sm:text-base font-medium mb-2 sm:mb-3">{member.role}</p>
        <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">{member.bio}</p>
...
const Section4 = () => {
  return (
    <section id="team" className="py-12 sm:py-16 md:py-20 bg-[#fdfdff]">
      <div className="container mx-auto px-4 sm:px-6">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-4">Meet Our Team</h2>
